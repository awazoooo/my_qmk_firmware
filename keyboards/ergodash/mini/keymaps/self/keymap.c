...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Reset|ADJUST|  ALt |  Cmd |||||||| Lower| Space| Space|||||||| Enter| Ctrl | Raise|||||||| Left | Down |  Up  | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    RESET,   ADJUST, KC_LALT, KC_LCMD,          LOWER,   KC_SPC , KC_SPC,          CTL_T(KC_ENT), KC_LCTL, RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
  ),
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Ctrl |  GUI |  ALt | Cmd  |||||||| Lower| Space| Space|||||||| Enter| Ctrl |   <  ||||||||   ,  |   .  |   >  |   /  |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_LOWER] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_LCMD,          LOWER,   KC_SPC , KC_SPC,       KC_ENT, KC_LCTL , KC_LT,            KC_COMM, KC_DOT, KC_GT, KC_SLSH \
  ),
  ...
  * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
  * | Ctrl |  F11 |  F12 | Cmd  |||||||| Lower| Space| Space|||||||| Enter| Ctrl | Raise|||||||| Home |PageDn|PageUp|  End |
  * ,----------------------------------------------------------------------------------------------------------------------.
  */
  [_RAISE] = LAYOUT(
    KC_GRV , KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_UNDS,                        KC_PLUS, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE, \
    ...
    KC_LCTL, KC_F11 , KC_F12,  KC_LCMD,          LOWER,   KC_SPC , KC_SPC,        KC_ENT, KC_LCTL , RAISE,            KC_HOME, KC_PGDN, KC_PGUP, KC_END   \
  ),
